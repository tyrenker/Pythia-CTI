...
import { Plus, Search, Activity, Archive, CheckCircle, Clock, Target } from 'lucide-react'
import { useHunts, useCreateHunt } from '@/api/hunts'
            ...
            {filtered.map(h => {
              ...
              return (
                <button
                  ...
                  className="flex w-full items-start gap-4 px-5 py-4 text-left transition-colors hover:bg-bg-elevated"
                >
